...
// Setting up the "Resend" service
// const resend = new Resend(process.env.RESEND_KEY);

//   CREATING & SIGNING JWT TOKEN
const signToken = (id) =>
...
exports.restrictTo =
  ...
  (req, res, next) => {
    ...
    if (!req.user) {
      return next(
        new AppError(
          'Please confirm user status. Log in to access this resource',
          401
        )
      );
    }

    // roles is an array containing 'restrictTo arguments'
