class APIFeatures {
  ...
  filter() {
    //1A) FILTERING             e.g.  ENDPOINT//localhost://3000/api/v1/tours?duration=5&difficulty=easy
    ...
    //1B) ADVANCED FILTERING     e.g.  ENDPOINT//localhost://3000/api/v1/tours?duration=5&difficulty=easy&price[gte]=400
